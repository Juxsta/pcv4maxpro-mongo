  ...
  */
  ...
  subject: 'Confrim your email with PilotCity',
  text: 'Confirm you email by clicking here',
  html: `<strong>Confrim your email by clicking <a href="localhost:8080/emailconfirmation?token=${token}?tokenId=${tokenId}">here</a></strong>`,
};
sgMail.send(msg);
    return { status: 'pending' };
  };
